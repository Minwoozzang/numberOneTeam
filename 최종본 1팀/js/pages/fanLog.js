...
export const commentLike = async (event) => {
  ...
  try {
    ...
    await updateDoc(commentRef1, { likeButton: `filter ${uid}` });
    getCommentList(selectedDate);
  } catch (error) {
    alert(error);
  }
...
export const commentHate = async (event) => {
  ...
  try {
    ...
    await updateDoc(commentRef1, { hateButton: `filter ${uid}` });
    getCommentList(selectedDate);
  } catch (error) {
    alert(error);
  }
...
export const getCommentList = async (time) => {
  ...
  document.querySelectorAll('.hate').forEach((el) => {
    ...
    if (el.className === `hate filter ${currentUid}`) {
      el.disabled = true;
    }
  });
};
...
//   const writeTitle = document.querySelector('.form-write-title');
//   const nickname = document.querySelector('#nickname');
//   const commentText = document.querySelectorAll('.comment_text');
//   const commentName = document.querySelectorAll('.comment_name_at');
//   // const writeCommentBtn = document.querySelectorAll('.write-comment__btn');

//   const body1 = document.querySelector('body');
//   const listBody = document.querySelector('.title-and-comment');
//   const mybtn = document.querySelector('.mypageDarkMode');
//   const mypageText = document.querySelectorAll('#card-text');
//   const mypageComment = document.querySelectorAll('.commentText');
//   const mypageTitle = document.querySelector('.title');

//   commentText.forEach((e) => {
//     if (btn.value === 'dark') {
//       body.style.backgroundColor = 'black';
//       body.style.color = 'white';
//       writeTitle.style.color = 'black';
...
//   commentName.forEach((e) => {
//     if (btn.value === 'dark') {
//       e.style.color = 'black';
//     }
//   });

//   mypageText.forEach((e) => {
//     if (btn.value === 'dark') {
//       body1.style.backgroundColor = 'black';
//       listBody.style.backgroundColor = 'black';
//       e.style.color = 'black';
//       mypageTitle.style.color = 'white';
//       btn.value = 'light';
//     }
//   });
// };
